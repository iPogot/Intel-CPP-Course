...
bool Plane::isparallel(Plane p) const  {
...
double Plane::get_x() const  {

    return norm_.get_x();

}

double Plane::get_y() const  {

    return norm_.get_y();

}

double Plane::get_z() const  {

    return norm_.get_z();

}

Vector Plane::get_norm() const  {
